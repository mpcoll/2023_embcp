...
outpath_3d = "/media/mp/lxhdd/2020_embcp/bashivan_deep/test1/3dspacespacefreq_larger"
if not os.path.exists(outpath_3d):
    os.makedirs(outpath_3d)
outpath_4d = "/media/mp/lxhdd/2020_embcp/bashivan_deep/test1/4dspacespacefreqtime"
